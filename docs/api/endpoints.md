...
| Method | Path                                                           | Auth            | Body                                                                    | Returns                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------ | -------------------------------------------------------------- | --------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET    | /api/admin/email-queues                                        | 🔒 `admin.mail` | —                                                                       | `EmailQueue[]` (no password; incl. sync/cursor fields, `mailboxEpoch`, typed `reconcileCause`, `reconcileRequestedAt`, server-computed `allowedModes`, and liveness stamps)                                                                                                                                                                                                                                                                                 |
