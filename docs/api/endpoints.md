...
| GET    | /api/admin/email-queues/inbound/health                         | 🔒 `admin.mail` | —                                                                                            | `{ queues[], ledger: { backlog, byState, stalledProcessing, oldestPendingAt, lastProcessedAt }, alerts[], checkedAt }` — halt / quarantine / stalled-lease / aged-backlog signals for a dashboard or probe                                                                                                                                                                  |
