...
| `20260723020000_inbound_raw_mime_staging_fence`  | inbound_raw_mime_staging_fence  | Adds a short-lived DB staging lease for filesystem raw-MIME writes. Acceptance consumes it transactionally and the reaper locks expired rows before deleting a file.                                                                                                                                                                                                                                                                                                                                                         |
