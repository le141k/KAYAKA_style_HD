...
| `EmailQueueReconcileCause`  | `LEGACY_MIGRATION`, `UIDVALIDITY_CHANGED`, `MAILBOX_IDENTITY_CHANGED`, `TRANSPORT_COLLISION`, `UNKNOWN` | `EmailQueue.reconcileCause`; backend derives allowed modes, not Web                                                                                                                                                                                               |
...
| `InboundDelivery`     | `(state, nextAttemptAt)`, `(queueId, mailboxEpoch, uidValidity, uid)`, `messageIdHash` |
| `InboundMessageClaim` | `messageIdHash`, `winnerDeliveryId`                                                    |
