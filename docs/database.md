...
| **RefreshToken** | `id` (UUID), `staffId`, `jti` (unique — opaque rotation id), `familyId` (indexed — rotation chain), `tokenHash` (unique), `expiresAt`, `revokedAt?`, `createdAt`                                                                   | belongs to `Staff` (cascade delete)                                                                                                                                           |
