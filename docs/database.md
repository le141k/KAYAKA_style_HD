...
| Model               | Key columns                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Relations                                               |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| **EmailQueue**      | `id`, `type EmailQueueType`, `emailAddress`, `host`, `port Int` (default 993), `username`, `passwordEnc` (encrypted at rest), `useTls Bool`, `departmentId?`, `signature`, `isEnabled Bool`, `createdAt`; **IMAP cursor** `lastSeenUid BigInt`, `uidValidity BigInt?` (NULL = never bootstrapped), `syncState EmailQueueSyncState`, `lastError?`, `cursorGeneration Int`; **reconcile intent** `bootstrapPolicy EmailQueueBootstrapPolicy?` + `bootstrapBackfillLimit Int?` (per-queue override of the global bootstrap policy, consumed at next bootstrap) | Optional FK to `Department`; has many `InboundDelivery` |
