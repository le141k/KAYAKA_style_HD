...
const schema = z.object({
  ...
  TELECOM_HD_JWT_ACCESS_SECRET: z.string().min(8).default('change-me-access-secret'),
  TELECOM_HD_JWT_REFRESH_SECRET: z.string().min(8).default('change-me-refresh-secret'),
