...
const MOCK_NOTIFICATIONS: Notification[] = [
  {
    id: "1",
    type: "breach",
    message: "TT-000005 — SLA нарушен (NOC)",
  ...
  },
  {
    id: "2",
    type: "new",
    message: "Новая заявка TT-000006 от Иван Клиентов",
  ...
  },
  {
    id: "3",
    type: "resolved",
    message: "TT-000004 помечена как решённая",
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className={cn("text-xs", !n.read && "font-semibold")}>
                        {n.message}
                      </p>
